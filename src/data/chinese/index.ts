...
const u1 = unit(
  ...
  '拼音冲刺',
  [
    level('chinese-1-01', '易混声母：z/zh c/ch s/sh', [
      listenChoose(
        '听音选声母',
        '知',
        [
    ...
    level('chinese-1-02', '易混声母：n/l f/h', [
      listenChoose(
        '听音选声母',
        '牛奶',
        [
    ...
    level('chinese-1-03', '易混韵母：an/ang en/eng', [
      listenChoose(
        '听音选韵母',
        '安',
        [
      ...
      dragMatch('韵母和汉字配对', [
        { id: 'p1', left: 'an', right: '安' },
        { id: 'p2', left: 'ang', right: '长' },
        { id: 'p3', left: 'en', right: '门' },
        { id: 'p4', left: 'eng', right: '风' },
        { id: 'p5', left: 'an', right: '山' },
        { id: 'p6', left: 'ang', right: '上' },
      ]),
      quiz('前后鼻音辨析', [
        {
          id: 'q1',
          question: '「春天 chūn tiān」的「天」韵母是？',
          options: [
            { id: 'a', label: 'an' },
            { id: 'b', label: 'ang' },
            { id: 'c', label: 'ian' },
    ...
    level('chinese-1-04', '易混韵母：in/ing üan/uan', [
      listenChoose(
        '听音选韵母',
        '星星',
        [
      ...
      dragMatch('韵母辨析配对', [
        ...
        { id: 'p3', left: 'üan', right: '远' },
        { id: 'p4', left: 'uan', right: '玩' },
        { id: 'p5', left: 'in', right: '认真' },
        { id: 'p6', left: 'ing', right: '明' },
      ]),
      quiz('in/ing üan/uan 辨析', [
        {
          id: 'q1',
    ...
    level('chinese-1-05', '三拼与整体认读辨析', [
      dragMatch('整体认读还是三拼', [
        { id: 'p1', left: 'yuán', right: '整体认读' },
        { id: 'p2', left: 'yán', right: '三拼音节' },
        { id: 'p3', left: 'yún', right: '整体认读' },
        { id: 'p4', left: 'yīn', right: '整体认读' },
        { id: 'p5', left: 'xiǎo', right: '三拼音节' },
        { id: 'p6', left: 'zhuāng', right: '三拼音节' },
      ]),
      blend('三拼音节拼读', [
        { id: 'b1', parts: ['x', 'i', 'ào'], result: 'xiào', speak: '笑' },
        { id: 'b2', parts: ['j', 'i', 'ān'], result: 'jiān', speak: '间' },
        { id: 'b3', parts: ['g', 'u', 'āng'], result: 'guāng', speak: '光' },
        { id: 'b4', parts: ['q', 'u', 'án'], result: 'quán', speak: '全' },
      ]),
      quiz('整体认读辨析', [
        {
          id: 'q1',
          question: 'yuán（元/园）属于？',
          options: [
            { id: 'a', label: '整体认读音节' },
            { id: 'b', label: '两拼音节' },
            { id: 'c', label: '三拼音节' },
    ...
    ], 'yuan/yan yun/yin 要分清'),

    level('chinese-1-06', '四声·轻声·一不变调', [
      listenChoose(
        '听音选声调',
        '马',
        [
      ...
      quiz('声调与变调', [
        {
          id: 'q1',
          question: 'mā 妈、má 麻、mǎ 马、mà 骂 ——「马」是第几声？',
          options: [
            { id: 'a', label: '一声' },
            { id: 'b', label: '三声' },
            { id: 'c', label: '四声' },
      ...
      dragMatch('词语和正确注音', [
        { id: 'p1', left: '爸爸', right: 'bà ba' },
        { id: 'p2', left: '明白', right: 'míng bai' },
        { id: 'p3', left: '一会儿', right: 'yí huìr' },
        { id: 'p4', left: '一样', right: 'yí yàng' },
      ]),
    ], '四声、轻声与「一」「不」变调'),

    level('chinese-1-07', '看拼音选汉字', [
      quiz('同音不同调', [
        {
          id: 'q1',
          question: 'mā 是哪个字？',
    ...
    level('chinese-1-08', '快速拼读词语', [
      blend('两拼读词语', [
        { id: 'b1', parts: ['x', 'ué'], result: 'xué', speak: '学' },
        { id: 'b2', parts: ['xiào'], result: 'xiào', speak: '校' },
        { id: 'b3', parts: ['péng'], result: 'péng', speak: '朋' },
        { id: 'b4', parts: ['y', 'ou'], result: 'you', speak: '友' },
        { id: 'b5', parts: ['l', 'ǎo'], result: 'lǎo', speak: '老' },
        { id: 'b6', parts: ['sh', 'ī'], result: 'shī', speak: '师' },
      ]),
      blend('三拼读词语', [
        { id: 'b7', parts: ['x', 'i', 'ǎng'], result: 'xiǎng', speak: '想' },
        { id: 'b8', parts: ['n', 'i', 'àn'], result: 'niàn', speak: '念' },
        { id: 'b9', parts: ['g', 'u', 'ān'], result: 'guān', speak: '关' },
        { id: 'b10', parts: ['x', 'i', 'n'], result: 'xīn', speak: '心' },
        { id: 'b11', parts: ['j', 'i', 'àn'], result: 'jiàn', speak: '见' },
        { id: 'b12', parts: ['m', 'i', 'àn'], result: 'miàn', speak: '面' },
      ]),
      quiz('拼读选词', [
        {
          id: 'q1',
          question: 'xué xiào 拼出来是？',
          options: [
            { id: 'a', label: '学校' },
            { id: 'b', label: '学生' },
            { id: 'c', label: '学习' },
    ...
    level('chinese-1-09', '拼音纠错', [
      quiz('找出错误注音', [
        {
          ...
          options: [
            ...
            { id: 'b', label: '花朵 huā duó' },
            { id: 'c', label: '老师 lǎo shī' },
          ],
          answerId: 'b',
        ...
        },
        {
          ...
          question: '哪个词语注音有误？',
          options: [
            { id: 'a', label: '长(cháng)短' },
            { id: 'b', label: '长(zhǎng)大' },
            { id: 'c', label: '长(cháng)大' },
          ],
          answerId: 'c',
          explain: '「长大」的「长」读 zhǎng',
        },
        {
          id: 'q4',
      ...
      dragMatch('纠正错误配对', [
        { id: 'p1', left: 'huā duó ✗', right: 'huā duǒ' },
        { id: 'p2', left: 'cháng大 ✗', right: 'zhǎng大' },
        { id: 'p3', left: 'shān ✗(翘舌错)', right: 'sān 三' },
        { id: 'p4', left: 'tāng ✗(后鼻错)', right: 'tiān 天' },
      ]),
    ], '发现注音里的错误'),
  ],
  '易混音·快速拼读·词语注音'
...
const u2 = unit(
  ...
  [
    ...
    level('chinese-2-02', '形近字：土士·未末·己已', [
      dragMatch('形近字辨析', [
    ...
    level('chinese-2-03', '形近字：人入八·日曰·干千', [
      dragMatch('形近字配对', [
    ...
    level('chinese-2-04', '多音字辨析', [
      ...
      dragMatch('多音字和词语', [
        { id: 'p1', left: '长(cháng)', right: '长短' },
        { id: 'p2', left: '长(zhǎng)', right: '长大' },
        { id: 'p3', left: '行(xíng)', right: '行走' },
        { id: 'p4', left: '行(háng)', right: '银行' },
    ...
    level('chinese-2-05', '入学高频字：学习·校园', [
      tapRead('学习校园高频字', [
    ...
    level('chinese-2-06', '入学高频字：自然·家庭·身体', [
      tapRead('自然家庭身体', [
...
const u4 = unit(
  ...
  [
    ...
    level('chinese-4-04', '短文阅读（一）', [
      quiz('阅读：小明的早晨', [
        {
          id: 'q1',
          question:
            '「早上，小明背上书包，高高兴兴地去上学。路上，他看见太阳升起来了，小鸟在唱歌。」—— 小明去哪里？',
          options: [
            { id: 'a', label: '上学' },
            { id: 'b', label: '去公园' },
            { id: 'c', label: '去商店' },
      ...
      quiz('阅读：春天的公园', [
        {
          id: 'q4',
          question:
            '「春天来了，公园里的花儿开了，红的、黄的、白的，真美丽。小朋友们在草地上奔跑、玩耍。」—— 这是什么季节？',
          options: [
            { id: 'a', label: '春天' },
            { id: 'b', label: '冬天' },
            { id: 'c', label: '秋天' },
    ...
    level('chinese-4-05', '短文阅读（二）', [
      quiz('阅读：小兔子借书', [
        {
          id: 'q1',
          question:
            '「小兔子向小熊借了一本书。它认真地读完了，还把小熊的书还了，并说谢谢。」—— 小兔子向谁借书？',
          options: [
            { id: 'a', label: '小熊' },
            { id: 'b', label: '小鸟' },
            { id: 'c', label: '小猫' },
      ...
      quiz('阅读：为什么下雨', [
        {
          id: 'q4',
          question:
            '「乌云来了，天空暗了。不一会儿，雨点落下来了。小草和花儿喝饱了水，笑弯了腰。」—— 下雨前天空怎么样？',
          options: [
            { id: 'a', label: '变暗了' },
            { id: 'b', label: '更亮了' },
            { id: 'c', label: '出现彩虹' },
    ...
    level('chinese-4-08', '阅读表达综合', [
      quiz('根据短文选标题', [
        {
          id: 'q1',
          question:
            '「秋天到了，树叶变黄了。一阵风吹过，树叶飘飘落下来，像蝴蝶在飞。」—— 最好的标题是？',
          options: [
            { id: 'a', label: '秋天的落叶' },
            { id: 'b', label: '夏天游泳' },
            { id: 'c', label: '冬天下雪' },
        ...
        },
        {
          id: 'q3',
          question:
            '「妈妈做了香喷喷的饭菜，一家人围坐在一起，真幸福。」—— 最好的标题是？',
          options: [
            { id: 'a', label: '幸福的一家人' },
            { id: 'b', label: '去上学' },
            { id: 'c', label: '踢足球' },
